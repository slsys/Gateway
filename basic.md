...
1. Использовать большинство доступного Zigbee оборудования. Список поддерживаемого и протестированного оборудования доступен по [ссылке](/supported_devices). Новое оборудование может быть добавлено после обсуждения с командой.
...
[Список поддерживаемых устройств](/supported_devices)
