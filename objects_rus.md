...
Управление сетевыми флагами объекта. На 23.10.2023 доступен флаг MQTT.
...
Изменение типа данных, записываемых в объект, управление флагом передачи уведомлений в MQTT. Если объекта не существует, он будет создан. **Внимание**  функция может быть удалена в прошивках после 2023.10.23. Её заменят функции obj.setType() для настройки типов и obj.setShare() для настройки флагов.
