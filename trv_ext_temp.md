...
4. Если вы используете [эту термоголовку](/supported_devices?device=65), то на момент написания этой статьи (30.10.2021) она не обновляет сама текущую температуру (`local_temperature`).
