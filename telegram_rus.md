...
Теперь требуется инициилизовароть бота в стартовом скрипте init.lua, для этого войдите в редактов скриптов, создайте если ранее не создавали стартовый скрипт init.lua и пропишите токен телеграм. 
