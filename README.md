...
8.	Возможность установить прямые связи (Bind)[https://github.com/slsys/Gateway/edit/master/bind.md] между устройствами ZigBee без участия координатора для управления конечными устройствами.
