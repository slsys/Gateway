...
# Дополнительные возможности шлюза

1) Управление и просмотр сведений  устройствами через Web интерфейс шлюза. Он доступен по адресу http://ipadress на 80 порту.
2) Создание локальных автоматизаций внутри шлюза (Simplelink)[]
3) Возможность написания сценариев на языке [Lua](https://ru.wikipedia.org/wiki/Lua) (Simplelink)[]
2.	
3.	Возможность создания групп для управления несколькими устройствами одновременно.
4.	Возможность задать имя устройству.
5.	Возможность удаления устройства. 
6.	Возможность отображения маршрутов в web-интерфейсе.
7.	Возможность отображения источника питания и уровня заряда батареи в web-интерфейсе.
...
9.	Возможность управлять аппаратными светодиодами (адресными илиRGB). (в разработке)
