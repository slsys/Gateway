...
Многие устройствя Xiaomi  сами репортят модель, пэтому работают и пройденного интервью/

## Вопрос: Как добавит новое неподдерживаемое устройство Zigbee

Ответ: Многие устройства могут быть добавлены без непосредственного контакта. Вероятность добавления зависит от наличия конвертера в  [zigbee2mqtt](https://github.com/Koenkk/zigbee-herdsman-converters/blob/master/converters/fromZigbee.js)

Также неоспоримым приемуществом для добавления нового устройства является протокол взаимодействия в z2m. Запустить z2m в режиме дебага zigbee протокола можно следующим образом:
...
Далее необходимо выполнить нужные действия с усройством и сохранить вывод с экрана. Данные сообщения можно добавить в [issue](https://github.com/slsys/Gateway/issues) или с помощью сервиса [pastebin](https://pastebin.com)
