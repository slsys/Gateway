...
Управлять LED можно скриптами [LUA](/lua_rus.md), [HTTP API](/http_api_rus.md) и MQTT. Можно задавать яркость и цвет свечения, а также включать и выключать различные [эффекты](/led_control_rus.md#таблица-эффектов)
