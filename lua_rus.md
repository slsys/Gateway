...
**effect**  - опциональный параметр включает эффекты в соответствии с [таблицей](/led_effects.md)

**Примеры для различных устройств:** 

#### [Модернизированный  шлюз Xiaomi](https://modkam.ru/2019/11/25/obnovljaem-shljuz-xiaomi/) или индикаторное кольцо с обычными светодидами.  (На странице настроек Settigns-> Hardware  необходимо установить:Led Red (or addr): 5, Led Green: 27,  Led Blue: 21)
 
```lua
os.led('ON',255,200,1, 1)  --красный
os.led('ON',255,1,250, 1)  --зеленый
os.led('ON',255,1,1, 255)  --синий
os.led('OFF')  --выключить
```

#### Шлюз SLS DIN MINI (индикаторный светодиод)   или светодиодной кольцо [Modkam](https://modkam.ru/wp-content/uploads/2019/11/Mi_Gateway_Shield02.jpg):
(На странице настроек Settigns-> Hardware  необходимо установить:Led Red (or addr): 21, указать количество светодиодов Number addressable leds:1)
```lua
os.led('ON',255,200,1, 1)  --красный
os.led('ON',255,1,250, 1)  --зеленый
os.led('ON',255,1,1, 255)  --синий
