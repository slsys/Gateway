...
Взаимодействовать с шлюзом можно с помощью HTTP API комманд. Поддерживаются GET и POST сообщения.  В целях безопасности в меню Settings - Users можно ограничить доступ к информации  токену. В таком случае для доступа необходимо передавать &token=e9d38bed.......f4ef49476a2ed9575 
