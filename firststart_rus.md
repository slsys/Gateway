...
Далее  через браузера телефона следует  перейти  на страницу контроллера по адресу 192.168.1.1 и через меню Settings -> WiFi Setup настроить реквизиты вашей сети (SSID и пароль). 
