...
***Отказ от осветственности:*** осуществляя целевой  донат вы поддерживаете авторов проекта, это не означает, что устройство обязательно будет добавлено в поддерживаемые устройства. Авторы не гарантинуют, что после изучения методов и протоколов отдельных устройств, оно может быть поддержано существующей инфраструктурой. 
