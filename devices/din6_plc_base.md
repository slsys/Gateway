...
Программная составляющая - [SLS Pro](/sls_pro) прошивка позволяет как работать автономно, в т.ч. без сети, так и интегрироваться по MQTT/HTTP/Modbus/KNX и прочим протоколам (см. [документацию](/)).
