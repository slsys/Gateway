...
2) **Недправильный сброс устройства**. Необходимо обратиться к официальной инструкции на устройство и убедиться, что вы правильно переводите устройство в режим сопряжения.
...
### Zigbee -> cache_states
Отправка кешированных данных. Например, если  датчик температуры  и влажности прислал только температуру, при выбранном этом пункте  в сообщении будет отправлено новое и кешированное значение.  Если пункт не выбран  - в сообщении придет только новое значение. 
### Zigbee -> cache_states 
Передавать "пустое" значение если оно не полученно от устройства. 
