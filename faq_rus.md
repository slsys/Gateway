...
Подробно в документации [SimpleBind](/simplebind_rus.md)
...
Через [LUA или HTTP API](/led_control_rus.md)

---

## Вопрос: Как включить режим сопряжения боковой  кнопкой шлюза?

Ответ: [Обработка нажатий аппаратной кнопки шлюза](/lua_rus.md#обработка-нажатий-аппаратной-кнопки-шлюза)
